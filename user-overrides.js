...
user_pref("privacy.userContext.enabled", false);                    // whether to enable Container tabs - personally i disable this in favor of FPI (privacy.firstparty.isolate)
user_pref("privacy.userContext.ui.enabled", false);                 // whether to enable the UI for Container tabs
...
user_pref("browser.cache.offline.enable", true);                   // [PRIV=false] whether to allow off-line caching
...
user_pref("browser.sessionstore.max_tabs_undo", 5);                 // how many tabs that can be restored when restarting the browser if session restore is enabled, as well as how many closed tabs can be re-opened while browsing
...
user_pref("extensions.screenshots.disabled", false);                 // [SET] [PRIV=true] disable the screenshots system add-on
 ...
 */
user_pref("general.smoothScroll.lines.durationMaxMS", 00);         // smooth the start/end of line scrolling operations in ms (up/down arrow/page keys)
user_pref("general.smoothScroll.lines.durationMinMS", 00);         // smooth the start/end of line scrolling operations in ms (up/down arrow/page keys)
user_pref("general.smoothScroll.mouseWheel.durationMaxMS", 00);    // smooth the start/end of scrolling operations in ms
user_pref("general.smoothScroll.mouseWheel.durationMinMS", 00);    // smooth the start/end of scrolling operations in ms
user_pref("general.smoothScroll.other.durationMaxMS", 00);         // smooth the start/end of other scrolling operations in ms
user_pref("general.smoothScroll.other.durationMinMS", 00);         // smooth the start/end of other scrolling operations in ms
user_pref("general.smoothScroll.pages.durationMaxMS", 00);         // smooth the start/end of page scrolling operations in ms (PgUp/PgDn keys)
user_pref("general.smoothScroll.pages.durationMinMS", 00);         // smooth the start/end of page scrolling operations in ms (PgUp/PgDn keys)
user_pref("mousewheel.acceleration.factor", 7);                    // sets acceleration factor if mouse wheel.acceleration.start > -1
...
user_pref("mousewheel.min_line_scroll_amount", 7);                 // if the CSS line height is smaller than this value in pixels, each scroll click will scroll this amount
